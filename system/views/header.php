...
<html>
<head>
	<title>Store Locator Admin<?php if( isset( $registry->page_title ) ): ?> - <?php echo ucwords( $registry->page_title ) ?><?php endif; ?></title>
...
<body id="<?php if( isset( $registry->controller ) ): ?><?php e( str_replace( '/', '_', $registry->controller ) ) ?><?php endif; ?>" class="<?php echo get_body_classes( $config ) ?>"<?php echo get_body_data( $config ) ?>>
